    ...
    <div className="mx-auto flex h-16 max-w-screen-xl items-center justify-between gap-8 px-4 sm:px-6 lg:px-8">
      <a className="block text-teal-600 dark:text-teal-300" href="#">
       ...
       <div className="hidden md:block w-full">
        <input type="search" name="search" className="w-full px-2 outline-none py-1" id="" placeholder="search.." />
       </div>
        ...
        <div className="flex items-center gap-4">
          <div className="sm:flex sm:gap-4">
            <a
              className="flex items-center gap-2 rounded-md bg-teal-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-teal-700 dark:hover:bg-teal-500"
              href="#"
            >
              <IoIosLogIn className="text-lg"/>Login
            </a>
            ...
            <a
              ...
              href="#"
            >
              <LuShoppingCart className="text-lg" />Cart
            </a>
          </div>
